      ...
      <svg class='menu-logo' onclick="togglemenu()" fill="#fefefe" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="24px" height="24px"><path d="M 3 5 A 1.0001 1.0001 0 1 0 3 7 L 21 7 A 1.0001 1.0001 0 1 0 21 5 L 3 5 z M 3 11 A 1.0001 1.0001 0 1 0 3 13 L 21 13 A 1.0001 1.0001 0 1 0 21 11 L 3 11 z M 3 17 A 1.0001 1.0001 0 1 0 3 19 L 21 19 A 1.0001 1.0001 0 1 0 21 17 L 3 17 z"/></svg>
		...
		<div id="wrapper" class="iner">
			<section id="MenaxhimiPerdoruesve" class="wrapper style3 fade-up"  style="border: none;" >
				<div class="inner" style="display: flex; justify-content: center; align-items: center;flex-direction: column; height: 40em;">
				<h2 class="title" style="text-align:center; font-size:1.6em; color: rgb(0,33,68);">Platforma Digjitale per Vleresimin Projektet Individuale (PDVPI)</h2>
                <h3 style="text-align:center; font-size:1.4em; color: rgb(0,33,68);">MENAXHIMI TË DHËNAVE</h3>
									...
									<div class="fa fa-cogs" style="font-size:36px"> </div>
										<div class="col-12">
											<ul class="actions"  style="display: flex; justify-content: center;	align-items: center;"> 
												<li><a  href="menaxhimiteDhenave.php"><input type="submit" value="Menaxho Të Dhëna" class="primary"  style="margin-top: 10%;" /></a></li>
											</ul>
										</div>
								</section>
							</div>
							...
							<div class="features" style="border: none;">
								<section style="border: none; ">
									<div class="fa fa-cogs" style="font-size:36px"> </div>
										<div class="col-12">
											<ul class="actions"  style="display: flex; justify-content: center;	align-items: center;"> 
											<li><a  href="menaxhimiMenyve.php"><input type="submit" value="Menaxho Menytë" class="primary"  style="margin-top: 10%;" /></a> </li>
