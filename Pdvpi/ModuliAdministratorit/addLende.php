...
<html>
	...
	<body class="is-preload">
        ...
        if(isset($_POST['shtolende'])) {	
            ...
            if(empty($lenda)) {			
                if(empty($lenda)) {echo "<font color='red'>username field is empty.</font><br/>";}
                ...
                $result = mysqli_query($conn, "CALL InsertADDLende('$lenda')");
                //display success messpassword
            echo "<script>
                setTimeout(function(){
                    window.location.href = 'menaxhimiLendeve.php';
                }, 2000);
            </script>";
