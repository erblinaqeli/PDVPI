				...
				<div id="wrapper" >
					<section id="one" class="wrapper style3 fade-up" style="border-top: solid rgb(177, 177, 177) 2px;">
						<div class="inner">
								...
								<section style="border-left: #fff;">
									<div class="features" style="border: none;">
										<section style="border: none;">
											<div class="col-12">
											<form  enctype="multipart/form-data"  action="addLA.php" method="post" name="form1"  >
													<h2 class="major"  style="display: flex; justify-content: center;	align-items: center; width: max-content;" >Regjistro Lëndët e Asistentit</h2>
													...
													<option selected="selected">Zgjedh Asistentin</option>
														<?php
														$res = mysqli_query($conn50,"CALL SelectIDURole3()");
													...
													<option selected="selected">Zgjedh Lëndën</option>
														<?php
														$res = mysqli_query($conn49,"CALL SelectLendet()");
														while($row=$res->fetch_array())
														{
															?>
														...
														<div class="col-12">
															<ul class="actions"  style="display: flex; justify-content: center;	align-items: center;"> 
																<li><input type="submit" name="shtoLA" value="Shto" class="primary" /></li>
															</ul>
														</div>
													</div>
												</form>
							...
							<form action="regjistroLendetAsist.php" method="post" style="width: 90%; ">  				
								<div class="row gtr-uniform" style="  display: flex; flex-direction: row;">
									<h3>Kërko të dhënat e Lëndës së Asistentit</h3>
							...
							<div class="table-wrapper">
								<table class="alt" style="width: 90%; margin: auto; padding-bottom: 5%; ">
									...
									<?php
										...
										$term = mysqli_real_escape_string($conn51,$_REQUEST['term']);     
										$sql = mysqli_query ($conn51, "CALL SelcetTermLendetASist('$term')"); 
										...
										{ 		
												...
												echo "<td style='text-align: center;'><a href=\"deleteLendAsist.php?uid=$row[uid]&uid_lenda=$row[uid_lenda]\"  onClick=\"return confirm('A jeni të sigurt se dëshironi të fshini të dhënën?')\"  class='button primary'><font color='white'>Fshijë</font></a> </td> </tr>";			
											}
										}
									?>
								</table>
