				...
				<div id="wrapper" >
					<section id="one" class="wrapper style3 fade-up" style="border-top: solid rgb(177, 177, 177) 2px;">
						<div class="inner">
								...
								<section style="border-left: #fff;">
									<div class="features" style="border: none;">
										<section style="border: none;">
											<div class="col-12">
												<form  enctype="multipart/form-data"  action="addLP.php" method="post" name="form1"  >
													<h2 class="major"  style="display: flex; justify-content: center;	align-items: center; width: max-content;" >Regjistro Lëndët e Profesorit</h2>
													...
													<option selected="selected">Zgjedh Profesorin</option>
														<?php
														$res = mysqli_query($conn52,"CALL SelectIDURole2()");
													...
													<option selected="selected">Zgjedh Lëndën</option>
														<?php
														$res = mysqli_query($conn53,"CALL SelectLendet()");
														while($row=$res->fetch_array())
														{
															?>
														...
														<div class="col-12">
															<ul class="actions"  style="display: flex; justify-content: center;	align-items: center;"> 
																<li><input type="submit" name="shtoLP" value="Shto" class="primary" /></li>
															</ul>
														</div>
													</div>
												</form>
							...
							<form action="regjistroLendetProf.php" method="post" style="width: 90%; ">  				
								<div class="row gtr-uniform" style="  display: flex; flex-direction: row;">
									<h3>Kërko të dhënat e Lëndës së Profesorit</h3>
							...
							<div class="table-wrapper">
								<table class="alt" style="width: 90%; margin: auto; padding-bottom: 5%; ">
									...
									<?php
										...
										$term = mysqli_real_escape_string($conn54,$_REQUEST['term']);     
										$sql = mysqli_query ($conn54, "CALL SelectTermLendProf('$term')"); 
										...
										{ 		
												...
												echo "<td style='text-align: center;'><a href=\"deleteLendProf.php?uid=$row[uid]&uid_lenda=$row[uid_lenda]\"  onClick=\"return confirm('A jeni të sigurt se dëshironi të fshini të dhënë?')\"  class='button primary'><font color='white'>Fshijë</font></a> </td> </tr>";			
											}
										}
									?>
								</table>
