  ...
  height: 4.5rem;            /* Footer height */
   ...
   <div class="content-wrap">
      ...
      <svg class='menu-logo' onclick="togglemenu()" fill="#fefefe" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="24px" height="24px"><path d="M 3 5 A 1.0001 1.0001 0 1 0 3 7 L 21 7 A 1.0001 1.0001 0 1 0 21 5 L 3 5 z M 3 11 A 1.0001 1.0001 0 1 0 3 13 L 21 13 A 1.0001 1.0001 0 1 0 21 11 L 3 11 z M 3 17 A 1.0001 1.0001 0 1 0 3 19 L 21 19 A 1.0001 1.0001 0 1 0 21 17 L 3 17 z"/></svg>
		...
		<!-- Wrapper -->
		<div id="wrapper">
			<section id="MenaxhimiTeDhenave" class="wrapper style3 fade-up" style="border-top: solid rgb(177, 177, 177) 2px;">
			<div class="inner">
					<h2 class="title">MENAXHIMI TË DHËNAVE</h2>
					<div class="features">
					   
						<section style="border: none; width: 55%;">
							<form action="menaxhimiteDhenave.php" enctype="multipart/form-data" method="post" style="width: 90%; ">  				
								...
								<table class="alt" style="width: 90%; margin: auto; padding-bottom: 5%;">
									<thead>
										<tr>
											...
											<th style="text-align: center;">Dosja</th>
											<th style="text-align: center;">Pamja E Faqes</th>
											<th style="text-align: center;">Modifiko</th>
										</tr>
									</thead>
									<?php
										if (!empty($_REQUEST['term2'])) {
										$term2 = mysqli_real_escape_string($conn47,$_REQUEST['term2']);     
										$sql = mysqli_query($conn47,	
										"CALL SelectTermTitulli('$term2')"); 
										while($row = mysqli_fetch_array($sql)) 
										{ 		
												echo "<tr style='text-align: center;'>";
												echo "<td style='text-align: center;'>".$row['titulli']."</td>";
												echo "<td style='text-align: center;'>".$row['pershkrimi']."</td>";
												echo "<td style='text-align: center;'>".$row['file']."</td>";
												echo "<td style='text-align: center;'>".$row['pageLayout']."</td>";	
												echo "<td style='text-align: center; color: #ffffff;'><a href=\"updateteDhenat.php?uid_TeDhenat=$row[uid_TeDhenat]\" class='button' class='button primary'><font color='white'>Modifiko</font></a> </td> </tr>";
