...
<html>
	...
	<title>Moduli Studentit</title>
        <link rel="icon" href="images/mobilelogo1.png">s
		<meta charset="utf-8" />
  ...
  height: 4.5rem;            /* Footer height */
   ...
   <div id="content-wrap">
      ...
      <svg class='menu-logo' onclick="togglemenu()" fill="#fefefe" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="24px" height="24px"><path d="M 3 5 A 1.0001 1.0001 0 1 0 3 7 L 21 7 A 1.0001 1.0001 0 1 0 21 5 L 3 5 z M 3 11 A 1.0001 1.0001 0 1 0 3 13 L 21 13 A 1.0001 1.0001 0 1 0 21 11 L 3 11 z M 3 17 A 1.0001 1.0001 0 1 0 3 19 L 21 19 A 1.0001 1.0001 0 1 0 21 17 L 3 17 z"/></svg>
			...
			<h2 style="margin-bottom:5%"class="title">EVIDENCA</h2>
 <div class="scroll">
					...
					<table class="alt" style="width: 20%; margin: 0%;">
						<thead class="shark-1" style="background-color: #fff;">
							<tr>
								...
								<th>Emri</th>
								<th>Mbiemri</th>
								<th  class='rotate'rowspan="4"><div>Java 1</div></th>
								<th  class='rotate'rowspan="4"><div>Java 2</div></th>
								<th  class='rotate'rowspan="4"><div>Java 3</div></th>
								<th  class='rotate'rowspan="4"><div>Java 4</div></th>
								<th  class='rotate'rowspan="4"><div>Java 5</div></th>
								<th  class='rotate'rowspan="4"><div>Java 6</div></th>
								<th  class='rotate'rowspan="4"><div>Java 7</div></th>
								<th  class='rotate'rowspan="4"><div>Java 8</div></th>
								<th  class='rotate'rowspan="4"><div>Java 9</div></th>
								<th  class='rotate'rowspan="4"><div>Java 10</div></th>
								<th  class='rotate'rowspan="4"><div>Java 11</div></th>
								<th  class='rotate'rowspan="4"><div>Java 12</div></th>
								<th  class='rotate'rowspan="4"><div>Java 13</div></th>
								<th  class='rotate'rowspan="4"><div>Java 14</div></th>
								<th  class='rotate'rowspan="4"><div>Java 15</div></th>
								<th  class='rotate'rowspan="4"><div>Pikët</div></th>
								<th  class='rotate'rowspan="4"><div>Totali</div></th>
						...
						<form class='form' method='get'>
								...
								// p.uid_Evidenca,
								// p.uid,
								// p.Java1,p.Java2, p.Java3,p.Java4,p.Java5,p.Java6,p.Java7,p.Java8,p.Java9,p.Java10,p.Java11,p.Java12,p.Java13,p.Java14,p.Java15,p.TotalEL,p.Piket,
								// s.uid_Student,
								// s.username,
								// s.email,
								// s.mbiemri,
								...
								$result = mysqli_query($conn29,"CALL SelectEvidencenL($id,'$login_user')" );//na nevoitet ne query
						...
						$result = mysqli_query($conn28,"CALL SelectEvidencenP($id,'$login_user')" );//na nevoitet ne query
					...
					<?php 				echo"<a class='button primary' href=\"export_excelEvidencenLU.php?id=$id\">Export Evidencën</a>"; ?>
