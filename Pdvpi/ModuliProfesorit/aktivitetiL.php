...
if($result==null)
  mysqli_free_rezultati($result);
            ...
            <?php
               if (isset($_GET['submit'])) {
                  ...
                  $result = mysqli_query($conn15,"CALL SelectFAFormulat()");
               ...
               $uid_aktivitetil = $_GET['uid_aktivitetil'];
               ...
               $Java14 = $_GET['Java14'];
               $Java15 = $_GET['Java15'];
               $query = mysqli_query($conn16,"CALL UpdateAktivitetiL($Java1,$Java2,$Java3,$Java4,$Java5,$Java6,$Java7,$Java8,$Java9,$Java10,$Java11,$Java12,$Java13,$Java14,$Java15,$uid_aktivitetil)");
               $query = mysqli_query($conn17,"CALL UpdateAktivitetiLPiket()");
               	$query = mysqli_query($conn18,"UPDATE
               	aktivitetil
               	SET
               	TotalAL =
               		Piket $FA");
 ...
 <div class="scroll">
            ...
            <form action="aktivitetiL.php?id=<?php echo $id ?>" method="post" style="width: 90%; "> 
               ...
               <thead  class="shark-1" style="background-color: #fff;">
                  ...
                  echo"	<form class='form' method='get' action='aktivitetiL.php?id=$id'>";
                        
                  echo"<input class='input' type='hidden' name='uid_aktivitetil' value='{$row1['uid_aktivitetil']}' />";
                  ...
                  echo "</form>";}
                        ...
                        $query1 = mysqli_query($conn19,"CALL SelectAktivitetinLP($id)");
                        while ($row1 = mysqli_fetch_array($query1)) {
            ...
            <?php 				
	echo"<form method='post' action='import_AktivitetinL.php?id=$id' enctype='multipart/form-data'>";
	...
	echo"</form>"; 
  ?>
					<?php 				echo"<a class='button primary' href=\"export_excelAktivitetinL.php?id=$id\">Export Listën e Aktivitetit</a>"; ?>
