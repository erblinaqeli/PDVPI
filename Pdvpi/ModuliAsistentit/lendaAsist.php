...
if($result==null)
            ...
            <h2 style="margin-bottom:5%"class="title">MENAXHO EVIDENCËN E STUDENTËVE</h2>
					...
					<?php
								...
								if (isset($_GET['submit'])) {
									$result = mysqli_query($conn7,"SELECT `FE` FROM formulat");
                  ...
                  while($res = mysqli_fetch_array($result))
                  {
                     ...
                     $FE = $res['FE'];
								...
								$uid_EvidencaU = $_GET['uid_EvidencaU'];
								...
								$query = mysqli_query($conn36,"UPDATE evidencau SET  
								...
								WHERE uid_EvidencaU=$uid_EvidencaU");
								...
								$id = $_REQUEST['id'];
								// echo"$id";
								// ktu me pru id e butonit qe e kemi shtyp
 ...
 <div class="scroll">
										...
										<form action="lendaAsist.php?id=<?php echo $id ?>" method="post" style="width: 90%; "> 
                        ...
                        echo"<th>Modifiko</th>";
								...
								echo"	<form class='form' method='get' action='lendaAsist.php?id=$id'>";

								echo"<input class='input' type='hidden' name='uid_EvidencaU' value='{$row1['uid_EvidencaU']}' />";
								...
								echo "<td><input class='button primary' type='submit' name='submit' value='MODIFKO' /></td>";
...
echo "</form>";
					...
					<?php 				
	echo"<form method='post' action='import_EvidencenU.php?id=$id' enctype='multipart/form-data'>";
	...
	echo"</form>"; 
  ?>
<?php 				echo"<a class='button primary' href=\"export_excelEvidencenU.php?id=$id\">Export Listën e Evidences</a>"; ?>
